...
export const projeto: Module<EstadoDoProjeto, Estado> = {
  ...
  actions: {
    ...
    [REMOVER_PROJETO] ({ commit }, id: string) {
      return http
        .delete(`/projetos/${id}`)
        .then(() => commit(EXCLUIR_PROJETO, id)); //Após a api retornar sucesso em excluir o projeto, executa essa mutation com commit
        //Essa mutation realizará a exclusão do estado local desse projeto
    },
  },
  getters: {
    projetos (state) {
